...
- [x] **8B-2**: Implement `frontend/src/components/admin/orders-table.tsx` using TanStack Table (or simpler table).
- [x] **8B-3**: Create `frontend/src/app/(dashboard)/admin/orders/[id]/page.tsx` (Order details view).
